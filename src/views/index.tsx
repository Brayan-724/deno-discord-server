    ...
    <html lang="en" class="bg-body-bg text-body-color">
      ...
      <body class="bg-body-bg text-body-color">
        <main class="h-full flex">
          ...
          <Channels username={user} />

          <div class="flex flex(col 1) bg-chat-bg h-full">
            <menu
              type="toolbar"
              class="flex-[0 0 57px] px-5 bg-menu-bg border-b-([1px] menu-bg) flex items-center"
            >
              <h2 class="font-bold text-[1.3rem] tracking-wider before:(content-['#'] mr-[2px] font-[300] text-[#8A8E94]) ">
                general
              </h2>
            </menu>
